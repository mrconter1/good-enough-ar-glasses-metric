...
- No tethering or compute pucks. A puck-dependent architecture is a different product trajectory entirely, not a stepping stone. Wireless offloading to a smartphone is fine since phones are already part of daily life.
- Two full-color displays, one per eye.
- Vergence-accommodation solved or fixed at a comfortable focal distance for desk work.
- Handles normal small head movements without the image breaking.
- Spatial tracking sufficient to lock virtual content to the real world is a baseline requirement, not scored.
